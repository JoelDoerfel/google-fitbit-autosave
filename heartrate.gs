...
// KEEP THESE HANDY FOR SETUP & TROUBLESHOOTING:
...
function saveAsSpreadsheet(){ 
  ...
  var range = sheet.getRange('Sheet1!A1:B'+lastRow);
  ...
  var destFolder = DriveApp.getFolderById("{YOUR_DESTINATION_FOLDER_ID}");   
  var saveDate = dateString;  
  DriveApp.getFileById(sheet.getId()).makeCopy("Fitbit Intraday "+saveDate, destFolder); 
